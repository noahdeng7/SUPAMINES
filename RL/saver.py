...
from model import adapt_state_dict
...
class TorchSaver(ModelSaver):
    ...
    def load(self, checkpoint_path: pathlib.Path, info: any):
        ...
        # A checkpoint written before the value head was split into V_R and the cost critic
        # is missing cost_head and carries three value rows; adapt it rather than refusing
        # to resume.  See model.adapt_state_dict.
        loaded_state = adapt_state_dict(loaded_state, self.model)
