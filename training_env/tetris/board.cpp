...
PyObject* Board_Height(PythonBoard* self, PyObject* Py_UNUSED(ignored)) {
...
// PythonBoard deliberately holds a BoardTmpl<8>, so the default tp_alloc is fine.
// If it ever gains one, this fires instead of segfaulting at random -- see
// AlignedAlloc in python.h.
static_assert(!kNeedsAlignedAlloc<PythonBoard>);
